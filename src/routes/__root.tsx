...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HydraNouaceur — Bornes d'incendie" },
      ...
      { property: "og:title", content: "HydraNouaceur" },
      { property: "og:description", content: "Cartographie des bornes d'incendie — province de Nouaceur." },
